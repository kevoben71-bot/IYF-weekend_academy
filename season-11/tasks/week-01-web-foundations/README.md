...
>
> **Repository Name:** `iyf-s11-week-01-{your-github-username}`
...
- [ ] Create your first week's repository: `iyf-s11-week-01-{your-github-username}`
...
1. Use your week-01 repository: `iyf-s11-week-01-{your-username}`
2. Push your `index.html` to the repository
3. Enable GitHub Pages (Settings → Pages → Source: main branch)
4. Wait 1-2 minutes for deployment
5. Access your live site at `https://yourusername.github.io/iyf-s11-week-01-yourusername`
